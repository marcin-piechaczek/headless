...
const ResetPass = () => {
  ...
  const resetPassSchema = Yup.object().shape({
    newPassword: Yup.string().min(8, 'Too Short!').max(50, 'Too Long!').required('Required'),
        ...
        <FormWrapperStyled>
          <Form className="bg-white px-8 pt-6 pb-8 mb-4">
            <FieldsetWrapperStyled>
              ...
              {resetPassword && (
                <div className="text-green-500 text-xs italic mb-5">
                  Poprawnie ustawiono nowe hasło!
                </div>
              )}
